            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="flex overflow-x-auto pb-2 mb-6 border-b border-slate-800">
                    <button
                        ...
                        className={`px-4 py-2 mr-2 whitespace-nowrap rounded-t-lg transition-colors ${activeSection === 'all' ? 'bg-slate-800 text-white' : 'text-slate-400 hover:text-white'}`}
                    >
                        All Information
                    </button>
                    <button
                        onClick={() => setActiveSection('personal')}
                        className={`px-4 py-2 mr-2 whitespace-nowrap rounded-t-lg transition-colors ${activeSection === 'personal' ? 'bg-slate-800 text-white' : 'text-slate-400 hover:text-white'}`}
                    >
                        Personal Information
                    </button>
                    <button
                        onClick={() => setActiveSection('education')}
                        className={`px-4 py-2 mr-2 whitespace-nowrap rounded-t-lg transition-colors ${activeSection === 'education' ? 'bg-slate-800 text-white' : 'text-slate-400 hover:text-white'}`}
                    >
                        Education
                    </button>
                    <button
                        onClick={() => setActiveSection('experience')}
                        className={`px-4 py-2 mr-2 whitespace-nowrap rounded-t-lg transition-colors ${activeSection === 'experience' ? 'bg-slate-800 text-white' : 'text-slate-400 hover:text-white'}`}
                    >
                        Experience
                    </button>
                    <button
                        onClick={() => setActiveSection('skills')}
                        className={`px-4 py-2 mr-2 whitespace-nowrap rounded-t-lg transition-colors ${activeSection === 'skills' ? 'bg-slate-800 text-white' : 'text-slate-400 hover:text-white'}`}
                    >
                        Skills
                    </button>
                </div>
                        ...
                        <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 shadow-lg">
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    {editMode ? (
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <p className="text-white">{profile.experienceLevel || 'Not specified'}</p>
                                        </div>
                                    )}
                                </div>
                                ...
                                <div className="md:col-span-2">
                                    <label className="block text-sm font-medium text-slate-400 mb-1">Portfolio URL</label>
                                    {editMode ? (
                                        <input
                                            type="url"
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            {profile.portfolioURL ? (
                                                ...
                                                <p className="text-slate-500 italic">No portfolio URL specified</p>
                                            )}
                                        </div>
                                    )}
                                </div>
                                        ...
                                        <div key={index} className="border border-slate-800 rounded-lg p-4 hover:bg-slate-800/50 transition-colors">
                                            <div className="flex flex-col md:flex-row md:justify-between md:items-start">
                                                <div>
                                                    ...
                                                    {edu.grade && (
                                                        <p className="text-blue-400 mt-1 text-sm">{edu.grade}</p>
                                                    )}
                                                </div>
                            ...
                            {editMode && showEducationForm && (
                                <div className="mt-6 border border-slate-700 rounded-lg p-4 bg-slate-800/50">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-4">
                                        ...
                                        <div className="md:col-span-2">
                                            <label className="block text-sm font-medium text-slate-400 mb-1">Grade/GPA</label>
                                            <input
                                                type="text"
                                                name="grade"
                    ...
                    {(activeSection === 'all' || activeSection === 'experience') && (
                        <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 shadow-lg">
                            ...
                            {profile.experience.length > 0 ? (
                                ...
                                <p className="text-slate-500 italic">No work experience added yet</p>
                            )}
                                ...
                                <div className="mt-6 border border-slate-700 rounded-lg p-4 bg-slate-800/50">
                                    ...
                                    <div className="flex justify-end mt-4 space-x-3">
                                        ...
                                        <button
                                            ...
                                            className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors"
                                        >
                                            {editingExperienceIndex >= 0 ? 'Update' : 'Add'} Experience
                                        </button>
                                    </div>
                                </div>
                            )}
